...
def test_fetch_price_history_graceful_on_api_error() -> None:
    ...
    from prismal.agents.subgraphs.financial.tools_finance import fetch_price_history
...
def test_fetch_crypto_ohlcv_graceful_on_ccxt_error() -> None:
    ...
    from prismal.agents.subgraphs.financial.tools_finance import fetch_crypto_ohlcv
...
def test_compute_indicators_returns_empty_on_exception() -> None:
    ...
    from prismal.agents.subgraphs.financial.tools_finance import compute_indicators
...
def test_fetch_fundamentals_returns_empty_for_crypto() -> None:
    ...
    from prismal.agents.subgraphs.financial.tools_finance import fetch_fundamentals
...
def test_compute_risk_metrics_graceful_on_error() -> None:
    ...
    from prismal.agents.subgraphs.financial.tools_finance import compute_risk_metrics
...
def test_disclaimer_constant_in_tools_finance() -> None:
    ...
    from prismal.agents.subgraphs.financial.tools_finance import _DISCLAIMER
...
def test_stub_price_returns_zeros() -> None:
    ...
    from prismal.agents.subgraphs.financial.tools_finance import _stub_price
