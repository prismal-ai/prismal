"""Unit tests for DocumentProcessorFactory (prismal.rag.loaders).
...
# ── UnsupportedDocumentTypeError is a PrismalError ─────────────────────────


def test_unsupported_document_type_error_is_prismal_error() -> None:
    """UnsupportedDocumentTypeError must be a subclass of PrismalError."""
    from prismal.core.exceptions import PrismalError

    assert issubclass(UnsupportedDocumentTypeError, PrismalError)
