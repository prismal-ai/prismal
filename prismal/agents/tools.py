...
from prismal.agents.context import channel_context_var
...
def duckdb_query(sql: str, source: str = "") -> str:
    ...
    """
    try:
        from prismal.data.duckdb_engine import DuckDBEngine
...
def create_chart(data: str, chart_type: str = "bar", title: str = "") -> str:
    ...
    *data* must be a JSON array of objects, e.g.::
    ...
    try:
        ...
        from prismal.data.polars_utils import save_chart
    except ImportError as exc:
...
def list_mcp_tools(server_name: str = "") -> str:
    ...
    """
    try:
        from prismal.agents.tool_registry import get_mcp_tools
...
def cron_add(
    ...
    """
    from prismal.scheduler.executor import get_running_executor
...
def remember_preference(section: str, fact: str) -> str:
    ...
    """
    try:
        from prismal.memory.preferences import PreferencesManager
